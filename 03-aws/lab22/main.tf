...
resource "aws_elb" "bar" {
  ...
  listener {
    ...
    lb_port            = 443
    lb_protocol        = "https"
    ssl_certificate_id = "arn:aws:acm:us-east-1:233700137337:certificate/d285a415-bd83-4d9f-a842-02029cad21f4"
  }
  ...
  instances                   = [aws_instance.app_server_01.id, aws_instance.app_server_02.id]
